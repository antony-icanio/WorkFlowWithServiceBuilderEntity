...
package com.mvcServiceBuilder.service.persistence.impl;
...
import com.mvcServiceBuilder.model.TimeSheetTable;
import com.mvcServiceBuilder.model.impl.TimeSheetImpl;
import com.mvcServiceBuilder.model.impl.TimeSheetModelImpl;
import com.mvcServiceBuilder.service.persistence.TimeSheetPersistence;
import com.mvcServiceBuilder.service.persistence.TimeSheetUtil;
...
/**
 * The persistence implementation for the time sheet service.
 *
 * <p>
 ...
 * @generated
 */
public class TimeSheetPersistenceImpl
	extends BasePersistenceImpl<TimeSheet> implements TimeSheetPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>TimeSheetUtil</code> to access the time sheet persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		TimeSheetImpl.class.getName();
	 ...
	 */
	@Override
	public List<TimeSheet> findByUuid(
	...
	public List<TimeSheet> findByUuid(
		...
		if (useFinderCache) {
			list = (List<TimeSheet>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (TimeSheet timeSheet : list) {
					if (!uuid.equals(timeSheet.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_TIMESHEET_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(TimeSheetModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<TimeSheet>)QueryUtil.list(
	...
	public TimeSheet findByUuid_First(
			String uuid, OrderByComparator<TimeSheet> orderByComparator)
		...
		throw new NoSuchTimeSheetException(sb.toString());
	}
	...
	public TimeSheet fetchByUuid_Last(
		...
		List<TimeSheet> list = findByUuid(
	...
	public TimeSheet[] findByUuid_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, timeSheet, uuid, orderByComparator, true);

			array[1] = timeSheet;

			array[2] = getByUuid_PrevAndNext(
				session, timeSheet, uuid, orderByComparator, false);
	...
	protected TimeSheet getByUuid_PrevAndNext(
		Session session, TimeSheet timeSheet, String uuid,
		...
		if (orderByComparator != null) {
			for (Object orderByConditionValue :
					orderByComparator.getOrderByConditionValues(timeSheet)) {
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_TIMESHEET_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(timeSheet.uuid IS NULL OR timeSheet.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(timeSheet.uuid IS NULL OR timeSheet.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<TimeSheet> findByUuid_C(
	...
	public TimeSheet findByUuid_C_First(
		...
		TimeSheet timeSheet = fetchByUuid_C_First(
	...
	public TimeSheet fetchByUuid_C_First(
		...
		List<TimeSheet> list = findByUuid_C(
	...
	public TimeSheet findByUuid_C_Last(
		...
		TimeSheet timeSheet = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public TimeSheet[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, timeSheet, uuid, companyId, orderByComparator, true);

			array[1] = timeSheet;

			array[2] = getByUuid_C_PrevAndNext(
				session, timeSheet, uuid, companyId, orderByComparator, false);
	...
	protected TimeSheet getByUuid_C_PrevAndNext(
		Session session, TimeSheet timeSheet, String uuid, long companyId,
		OrderByComparator<TimeSheet> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<TimeSheet> findByName(String name) {
	 ...
	 */
	@Override
	public List<TimeSheet> findByName(String name, int start, int end) {
	 ...
	 */
	@Override
	public List<TimeSheet> findByName(
	...
	public List<TimeSheet> findByName(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (TimeSheet timeSheet : list) {
					if (!name.equals(timeSheet.getName())) {
						list = null;
	...
	public TimeSheet findByName_First(
			String name, OrderByComparator<TimeSheet> orderByComparator)
		throws NoSuchTimeSheetException {

		TimeSheet timeSheet = fetchByName_First(name, orderByComparator);
	...
	public TimeSheet fetchByName_First(
		...
		List<TimeSheet> list = findByName(name, 0, 1, orderByComparator);
	...
	public TimeSheet findByName_Last(
		...
		TimeSheet timeSheet = fetchByName_Last(name, orderByComparator);
	...
	public TimeSheet fetchByName_Last(
		...
		List<TimeSheet> list = findByName(
	...
	public TimeSheet[] findByName_PrevAndNext(
		...
		try {
			...
			array[0] = getByName_PrevAndNext(
				session, timeSheet, name, orderByComparator, true);

			array[1] = timeSheet;

			array[2] = getByName_PrevAndNext(
				session, timeSheet, name, orderByComparator, false);
	...
	protected TimeSheet getByName_PrevAndNext(
		Session session, TimeSheet timeSheet, String name,
		OrderByComparator<TimeSheet> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_NAME_NAME_3 =
		"(timeSheet.name IS NULL OR timeSheet.name = '')";
	...
	public TimeSheetPersistenceImpl() {
		...
		setModelImplClass(TimeSheetImpl.class);
		setModelPKClass(long.class);

		setTable(TimeSheetTable.INSTANCE);
	}
	...
	public void cacheResult(List<TimeSheet> timeSheets) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (timeSheets.size() > _valueObjectFinderCacheListThreshold))) {
	...
	/**
	 * Clears the cache for all time sheets.
	 *
	 * <p>
	...
	public void clearCache() {
		...
		finderCache.clearCache(TimeSheetImpl.class);
	}

	/**
	 * Clears the cache for the time sheet.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	...
	public void clearCache(TimeSheet timeSheet) {
		entityCache.removeResult(TimeSheetImpl.class, timeSheet);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(TimeSheetImpl.class, primaryKey);
		}
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, timeSheetModelImpl);
	}
	...
	public TimeSheet create(long timeSheetId) {
		...
		timeSheet.setCompanyId(CompanyThreadLocal.getCompanyId());
	 ...
	 * Removes the time sheet with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the time sheet
	 * @return the time sheet that was removed
	 * @throws NoSuchTimeSheetException if a time sheet with the primary key could not be found
	 */
	@Override
	public TimeSheet remove(Serializable primaryKey)
		...
		try {
			...
			TimeSheet timeSheet = (TimeSheet)session.get(
		...
		catch (NoSuchTimeSheetException noSuchEntityException) {
	...
	protected TimeSheet removeImpl(TimeSheet timeSheet) {
		...
		try {
			...
			if (!session.contains(timeSheet)) {
				timeSheet = (TimeSheet)session.get(
					TimeSheetImpl.class, timeSheet.getPrimaryKeyObj());
			}
	...
	public TimeSheet updateImpl(TimeSheet timeSheet) {
		...
		if (!(timeSheet instanceof TimeSheetModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(timeSheet.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(timeSheet);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in timeSheet proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom TimeSheet implementation " +
					timeSheet.getClass());
		}
		...
		if (isNew && (timeSheet.getCreateDate() == null)) {
			if (serviceContext == null) {
				...
				timeSheet.setCreateDate(serviceContext.getCreateDate(date));
			}
		}

		if (!timeSheetModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				timeSheet.setModifiedDate(date);
			}
			else {
				timeSheet.setModifiedDate(serviceContext.getModifiedDate(date));
			}
		}
		...
		entityCache.putResult(
			TimeSheetImpl.class, timeSheetModelImpl, false, true);

		cacheUniqueFindersCache(timeSheetModelImpl);
	...
	/**
	 * Returns the time sheet with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the time sheet
	...
	public List<TimeSheet> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_TIMESHEET);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_TIMESHEET);
	...
	/**
	 * Initializes the time sheet persistence.
	 */
	public void afterPropertiesSet() {
		...
		_setTimeSheetUtilPersistence(this);
	}

	public void destroy() {
		_setTimeSheetUtilPersistence(null);

		entityCache.removeCache(TimeSheetImpl.class.getName());
	}

	private void _setTimeSheetUtilPersistence(
		TimeSheetPersistence timeSheetPersistence) {

		try {
			Field field = TimeSheetUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, timeSheetPersistence);
		}
	...
	private static final String _SQL_SELECT_TIMESHEET =
		"SELECT timeSheet FROM TimeSheet timeSheet";

	private static final String _SQL_SELECT_TIMESHEET_WHERE =
		"SELECT timeSheet FROM TimeSheet timeSheet WHERE ";

	private static final String _SQL_COUNT_TIMESHEET =
		"SELECT COUNT(timeSheet) FROM TimeSheet timeSheet";

	private static final String _SQL_COUNT_TIMESHEET_WHERE =
		"SELECT COUNT(timeSheet) FROM TimeSheet timeSheet WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS = "timeSheet.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No TimeSheet exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No TimeSheet exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		TimeSheetPersistenceImpl.class);
