...
public interface TimeSheetLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mvcServiceBuilder.service.impl.TimeSheetLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the time sheet local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TimeSheetLocalServiceUtil} if injection and service tracking are not available.
	 */
	public TimeSheet addTimeSheet(
			String jobName, String description, ServiceContext serviceContext)
